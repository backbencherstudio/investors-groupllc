...
export default function AddInvestmentDetailsPassive() {
  ...
  return (
    <div className="w-full mx-auto bg-white rounded-xl shadow p-6 mt-6 text-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          <label className="block mb-1 font-medium">Minimum Invest</label>
          <Input placeholder="Enter" />
        </div>
        <div>
          <label className="block mb-1 font-medium">Maximum Invest</label>
          <Input placeholder="Enter" />
        </div>
        <div>
          <label className="block mb-1 font-medium">Annual Return Rate</label>
          <Input placeholder="Enter" />
        </div>
        <div>
          <label className="block mb-1 font-medium">
