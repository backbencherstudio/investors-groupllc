    ...
    <div className="bg-white rounded-xl shadow-sm border overflow-hidden flex flex-col group">
      ...
      <div className="p-3 sm:p-4 flex-1 flex flex-col">
        ...
        <div className="flex items-start justify-between gap-3 mb-1">
          ...
          <div className="text-sm sm:text-base font-bold text-emerald-600 whitespace-nowrap">
            {formattedPrice}
          </div>
        </div>

        {/* Address */}
        <div className="mb-3 flex items-center gap-1 text-xs sm:text-sm text-slate-500">
