...
export const Vendors: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M11 11L6 6" stroke="#DD8800" stroke-width="1.5" />
      <path
